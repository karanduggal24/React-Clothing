...
//           <ul className="flex justify-around items-center m-0 min-h-[50px] p-0">
//             <li className="px-4 flex items-center">
//               <img src={logo} alt="logo" className="w-[75px] h-[75px] cursor-pointer" onClick={() => navigate('/')} />
//             </li>
//             <li className="px-4 flex items-center">
//               <NavLink 
//                 to="/" 
//                 className={({ isActive }) =>
//                   `font-sans text-base font-normal no-underline text-black px-5 py-3 rounded transition-all uppercase tracking-wider border-2 border-transparent relative
//                   ${isActive 
...
//                 </div>
//                 <button 
//                   className="rounded px-6 py-3 bg-white text-black border-2 border-black cursor-pointer font-sans text-sm font-medium uppercase tracking-wider transition-all min-w-[100px] hover:bg-black hover:text-white" 
